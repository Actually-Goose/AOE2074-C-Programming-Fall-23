...
typedef enum flight_mode_t
{
    ...
    /**
     * this allows the quadcopter to be controlled by voice commands in the 
     * x-, y-, and z-directions, and to be set to follow waypoints from
     * file
    */
    SPEECH
    /**
     * control the drone through speech generated by NLP team
    */
