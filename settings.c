...
int settings_load_from_file(const char* path)
{
    ...
    PARSE_STRING(wp_VOICE1_filename)
    PARSE_STRING(wp_VOICE2_filename)
    PARSE_STRING(wp_VOICE3_filename)
    PARSE_STRING(wp_VOICE4_filename)
    PARSE_STRING(wp_VOICE5_filename)
